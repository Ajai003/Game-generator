      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
          ...
          <div className="flex items-center gap-3">
            {socialLinks.map((social) => (
              <a
                ...
                className="w-9 h-9 rounded-lg bg-white/5 border border-white/5 flex items-center justify-center text-white/40 hover:text-white hover:bg-white/10 hover:border-white/15 transition-all duration-300"
              >
                <social.icon />
              </a>
            ))}
        ...
        <div className="mt-10 pt-6 border-t border-white/5 text-center">
          <p className="text-xs text-white/30">
            © 2026 Game Center. All rights reserved. Built for the future of
            gaming.
          </p>
        </div>
      </div>
